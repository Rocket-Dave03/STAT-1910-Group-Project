...
load_individual_data <- function(name) {
	...
	if (file.exists(cache_path)) {
		...
		write_csv(grad, cache_path)
	}
}

load_data <- function() {
	debt <- load_individual_data("debt")
	grad <- load_individual_data("graduation")
	
	# Income file has even weirder formatting
	# TODO: Implement
